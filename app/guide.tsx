...
const STEPS: Step[] = [
  {
    ...
    color: '#FF7A45',
    title: '홈 — 내 맛집 리스트',
    desc: '내가 담은 맛집이 모여요. "가고싶음"과 "방문함"을 따로 체크하고, 지역·카테고리로 필터링할 수 있어요.',
  },
  {
    icon: 'add-circle',
    color: '#FF7A45',
  ...
  },
  {
    ...
    desc: '모든 사용자의 맛집을 한 곳에서! 인기순·별점순·방문순으로 정렬하고, 몇 명이 담았는지와 담은 인기 유저 TOP3도 볼 수 있어요. 책갈피 버튼으로 바로 내 리스트에 담기!',
  },
  {
    icon: 'compass',
    color: '#6C5CE7',
    title: '둘러보기 — 다른 사람 리스트',
    desc: '친구·인플루언서들의 맛집 리스트를 구경해요. 좋아요를 누르면 인기 리스트가 위로 올라가고, 인스타 링크로 바로 이동할 수 있어요.',
  },
  {
    icon: 'person-circle',
    color: '#6C5CE7',
  ...
  },
  {
    ...
    color: '#00B894',
    title: '피드백 — 의견 보내기',
    desc: '오른쪽 위 말풍선 아이콘으로 건의·버그·정보수정을 보내주세요. 관리자가 1:1로 답글을 달아드려요!',
  },
];
    ...
    <SafeAreaView style={styles.safe} edges={['bottom']}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          <Image source={require('@/assets/icon.png')} style={styles.heroMark} />
        ...
        <View style={styles.tipCard}>
          <View style={styles.tipTitleRow}>
            <BrandIcon name="sparkle" size={14} color="#FF7A45" />
...
const styles = StyleSheet.create({
  ...
  heroMark: { width: 72, height: 72, borderRadius: 20 },
